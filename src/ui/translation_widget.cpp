...
namespace trnist::ui
{
		...
		, text_edit_(new QTextEdit(this))
	{
		...
		connect(translator_, &trnist::core::language::ITranslator::translate_received, this, &TranslationWidget::on_translation_changed_);
	}
	...
	void TranslationWidget::on_translation_changed_(const QString& translation)
	{
